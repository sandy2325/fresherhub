...
const mockSavedJobs: SavedJob[] = [
  { id: '1', userId: '1', jobId: '1', savedAt: '2024-01-15T10:00:00Z' },
  { id: '2', userId: '1', jobId: '3', savedAt: '2024-01-14T15:30:00Z' },
];

const mockAppliedJobs: JobApplication[] = [
  { id: '1', userId: '1', jobId: '2', appliedAt: '2024-01-13T09:15:00Z' },
  { id: '2', userId: '1', jobId: '4', appliedAt: '2024-01-12T14:20:00Z' },
];

const mockJobs: Record<string, Job> = {
  '1': { id: '1', title: 'Frontend Developer', companyName: 'TechCorp Solutions', location: 'Bangalore, Karnataka', salaryMin: 800000, salaryMax: 1500000, jobType: 'full-time', postedAt: '2024-01-15T10:00:00Z', isActive: true },
  '2': { id: '2', title: 'Junior Data Analyst', companyName: 'DataPro Analytics', location: 'Mumbai, Maharashtra', salaryMin: 600000, salaryMax: 1000000, jobType: 'full-time', postedAt: '2024-01-14T15:30:00Z', isActive: true },
  '3': { id: '3', title: 'Marketing Intern', companyName: 'BrandHub India', location: 'Delhi, NCR', salaryMin: 150000, salaryMax: 300000, jobType: 'internship', postedAt: '2024-01-13T09:15:00Z', isActive: true },
  '4': { id: '4', title: 'Backend Developer', companyName: 'StartupHub', location: 'Pune, Maharashtra', salaryMin: 1000000, salaryMax: 1800000, jobType: 'full-time', postedAt: '2024-01-12T14:20:00Z', isActive: true },
};
...
function DashboardContent() {
  ...
  const recentJobs = [...savedJobs.slice(0, 3), ...appliedJobs.slice(0, 3)]
    .sort((a, b) => new Date(b.appliedAt || b.savedAt).getTime() - new Date(a.appliedAt || b.savedAt).getTime())
    .slice(0, 5);
                              ...
                              <div key={index} className="flex items-start justify-between p-4 border border-gray-200 rounded-lg">
                                <div className="flex-1">
                                  ...
                                  <div className="text-right ml-4">
                                    ...
                                    {isSaved && (
                                      <Button variant="outline" size="sm" onClick={() => handleUnsaveJob(activity.id)}>
                                    ...
                                    <Button variant="outline" size="sm" onClick={() => handleApplyJob(job)}>
                            ...
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <div className="flex items-start space-x-3">
                                  <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center">
                                    <span className="text-lg">
                                      {job.title.includes('Frontend') ? '💻' : job.title.includes('Data') ? '📊' : '📝'}
                                    </span>
                                  </div>
                                  <div className="flex-1">
                                ...
                                <div className="text-right ml-4">
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <Button variant="outline" size="sm" onClick={() => handleUnsaveJob(savedJob.id)}>
                                      <XMarkIcon className="h-4 w-4" />
                                    </Button>
                                  </div>
                                </div>
              ...
              <Card className="p-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <Link key={index} href="/jobs" className="block p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors">
                      <div className="flex items-start space-x-3">
