      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-4 mb-4 md:mb-0">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-xl font-bold">FresherHub</span>
              </div>
              <p className="text-gray-400 text-sm">
                © {currentYear} FresherHub. All rights reserved.
              </p>
            </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-400">
            <p>
              Your trusted platform for finding fresher opportunities in India.
              Connecting talented freshers with their dream careers.
            </p>
          </div>
        </div>
      </div>
